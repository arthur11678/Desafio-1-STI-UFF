...
if aluno == -1:                                                 #As próximas etapas são executadas para tratamento de erros
    ...
    Cadastro(aluno, None).geraropecoes()                        #Gera as opções de email, printa a confirmação e edita o arquivo CVS
